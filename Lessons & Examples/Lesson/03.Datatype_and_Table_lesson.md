...
INSERT INTO nhan_vien (dang_lam) VALUES (TRUE);
INSERT INTO nhan_vien (dang_lam) VALUES ('true');
INSERT INTO nhan_vien (dang_lam) VALUES ('yes');
INSERT INTO nhan_vien (dang_lam) VALUES ('1');
```
...
```sql
-- Không truyền ngay_vao và dang_lam → tự dùng DEFAULT
INSERT INTO nhan_vien (ho_ten, phong_ban) VALUES ('Trần Mai', 'Kế toán');
-- ngay_vao = NOW() (thời điểm insert)
-- dang_lam = TRUE
```
...
| Giá | NUMERIC(12,2) | Tiền tệ → cần chính xác tuyệt đối |
...
```sql
INSERT INTO san_pham (ten_sp, gia, so_luong_ton, mo_ta, ngay_nhap, con_ban)
VALUES
...
SELECT ten_sp, gia, so_luong_ton FROM san_pham WHERE con_ban = TRUE;
```
