# AGENTS.md — PostgreSQL Learning Project
...
- Built following the design system in `.Codex/html_slide_skill.md`
...
8. **When creating HTML slides** — follow `.Codex/html_slide_skill.md` exactly:
...
Skill files live in `.Codex/` and define repeatable patterns for content generation:
